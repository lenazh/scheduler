  ...
  describe 'When sections belong to different lectures', ->
    ...
    describe '"private" methods', ->
      ...
      describe 'functions updating the index', ->
        ...
        describe '_resetSection(section)', ->
          section = {}

          beforeEach ->
            section = {}
            solver._resetSection section
      ...
      describe '_unassign(gsi, section, index)', ->  
        beforeEach ->
          spyOn(solver, '_resetSection')
          spyOn(GSIs, 'unassign')
          solver._unassign { name: 'FakeGsi'}, { name: 'FakeSection' }

        it 'calls solver._resetSection(...) with correct parameters', ->
          expect(solver._resetSection)
            .toHaveBeenCalledWith { name: 'FakeSection' }
